{{-- resources/views/livewire/employee/employee-edit.blade.php --}}
<div>
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-secondary-900">Edit Karyawan</h1>
                <p class="text-sm text-secondary-600 mt-1">{{ $employee->employee_number }} - {{ $employee->full_name }}</p>
            </div>
                    ...
                    <div class="card-body space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input wire:model="resign_date" type="date" class="form-input">
                                @error('resign_date') <span class="form-error">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label class="form-label">Status <span class="text-danger-500">*</span></label>
                                <select wire:model="status" class="form-input" required>
            ...
            <div class="space-y-6">
                    ...
                    <div class="card-body">
                        <div class="flex flex-col items-center">
                            ...
                            @elseif ($existing_photo)
                                <img src="{{ Storage::url($existing_photo) }}" class="h-32 w-32 rounded-full object-cover mb-4">
                            @else
                ...
                <div class="card">
                    <div class="card-body">
                        <dl class="space-y-2">
                            <div>
                                <dt class="text-xs text-secondary-600">NIK</dt>
                                <dd class="text-sm font-medium text-secondary-900">{{ $employee->employee_number }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs text-secondary-600">Dibuat</dt>
                                <dd class="text-sm text-secondary-900">{{ $employee->created_at->format('d M Y H:i') }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs text-secondary-600">Terakhir Update</dt>
                                <dd class="text-sm text-secondary-900">{{ $employee->updated_at->format('d M Y H:i') }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
